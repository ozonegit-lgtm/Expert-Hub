...
return [
    ...
    'connections' => [
        ...
        'mysql' => ['driver' => 'mysql', 'url' => env('DB_URL'), 'host' => env('DB_HOST', 'mysql'), 'port' => env('DB_PORT', '3306'), 'database' => env('DB_DATABASE', 'expert_hub'), 'username' => env('DB_USERNAME', 'expert_hub'), 'password' => env('DB_PASSWORD', ''), 'unix_socket' => env('DB_SOCKET', ''), 'charset' => env('DB_CHARSET', 'utf8mb4'), 'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'), 'prefix' => '', 'prefix_indexes' => true, 'strict' => true, 'engine' => null, 'options' => extension_loaded('pdo_mysql') ? array_filter([PDO::ATTR_TIMEOUT => 5]) : []],
    ],
